...
# ruff: noqa: C401
"""Vendored vLLM 0.24.0 scheduler with Beam resource admission."""
...
UPSTREAM_SCHEDULE_SHA256 = (
    "7b869a5dcbce4fc0b6077138c5c17f2ebf93890744282479f281e10bc9d6b0b1"
)


# fmt: off
def schedule_v024(self, throttle_prefills: bool = False) -> SchedulerOutput:
    self.current_step += 1
    ...
    if not preempted_reqs and self._pause_state == PauseState.UNPAUSED:
        ...
        while (self.waiting or self.skipped_waiting) and token_budget > 0:
            ...
            if len(self.running) + required_slots > self.max_num_running_reqs:
                break
